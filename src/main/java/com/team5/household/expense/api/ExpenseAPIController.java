...
public class ExpenseAPIController {
    ...
    @Autowired
    LchCultureCategoryRepository lRepo;

    @Autowired
    LchCultureDetailCategoryRepository ldRepo;
...
//    @Operation(summary = "날짜 지출내역 조회", description = "날짜로 지출내역을 출력합니다")
//    @GetMapping("/datelist")
//    public Map<String, Object> getDate(
////            @Parameter(description = "날짜", example = "2022-02-09") @RequestParam LocalDateTime ehDate,
//            @Parameter(description = "회원번호") @RequestParam Long ehMiSeq
//    ) {
//        ExpenseEntity entity = eRepo.findByehMiSeq(ehMiSeq);
////        LchCultureCategoryEntity lchentity = lRepo.findByCcSeq(entity.getEhCcSeq());
////        LchCultureDetailCategoryEntity lchdentity = ldRepo.findBycdcSeq(entity.getEhCdcSeq());
////        PaymentInfoEntity payentity = pRepo.findByPiSeq(entity.getEhPiSeq());
//
//        Map<String, Object> map = new LinkedHashMap<>();
////        if(eRepo.countByehMiSeq(ehMiSeq) == 1) {
//            map.put("ehTitle",entity.getEhTitle());
//            map.put("ehDate",entity.getEhDate());
////            map.put("ccName",lchentity.getCcName());
////            map.put("cdcName",lchdentity.getCdcName());
//            map.put("ehLocation", entity.getEhLocation());
////            map.put("piName", payentity.getPiName());
//            map.put("ehPrice", entity.getEhPrice());
////        }
////        else {
////            map.put("status", false);
////            map.put("message", "존재하지 않는 입니다.");
